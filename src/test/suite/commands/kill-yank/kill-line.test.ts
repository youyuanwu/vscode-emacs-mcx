...
`
  ...
  suite("when prefix argument specified", () => {
    ...
    test("it kills multiple lines and does not leave a blank line (the case the cursor is at the beginning of the line)", async () => {
      setEmptyCursors(activeTextEditor, [0, 0]);
...
`
    ...
    test("it works in the same way to the default (the case the cursor is NOT at the beginning of the line)", async () => {
...
ABCDEFGHIJ`
  ...
  suite("when prefix argument specified", () => {
    ...
    test("it works in the same way to the default (the case the cursor is at the beginning of the line)", async () => {
      setEmptyCursors(activeTextEditor, [0, 0]);
